    ...
    const inventors = [
      ...
      // 5. Sort the inventors by years lived
        const lived = inventors.sort(function(a,b) {
          const ayrs = a.passed - a.year;
          const byrs = b.passed - b.year;

          return ayrs>byrs? -1:1;
        })
      ...
      // let nametextlist = links.map(link => link.innerText);
      ...
      // Sort the people alphabetically by last name
        const alpha = people.sort(function (firstName,lastName){
          console.log(firstName);

          const [aFirst,aLast] = firstName.split(', ');   // const [a,b] = [b,c] is known as Destructuring assignment
